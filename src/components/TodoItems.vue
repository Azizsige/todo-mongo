  ...
  <div class="p-4 sm:ml-64 font-Roboto">
    <div class="p-4 mt-14">
      ...
      <div v-if="todoLength == 0" class="mt-10 list-todo">
        ...
        >
          <h5
            class="mb-2 text-2xl font-bold tracking-tight text-center text-white"
          >
            No Todo
          </h5>
        </div>
                  ...
                  >
                    <div class="text__todo">
                      ...
                      <div class="todo__description text-[#787878] text-[22px]">
                        ...
                        <h5 v-else class="text-gray-300">
                          Description belum diatur
                        </h5>
                      </div>
                    </div>
                    <div class="mt-5 md:text-right sm:mt-0 text__create">
                      <div
                        class="create__date text-[#787878] text-[16px] underline"
                      >
